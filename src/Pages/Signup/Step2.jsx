    ...
    if (values.username) {
      ...
      try {
        const response = await axios.post(
          "http://127.0.0.1:3309/api/auth/register",
          values
        );
        if (Response || response.status === 200) isError = true;
          ...
          <div className="frame-3">
            ...
            <div className="frame-4">
              ...
              <div className="frame-6">
                ...
                <p className="reward">
                  {" "}
                  0/{maxWords - text.trim().split(/\s+/).length}
                </p>
              </div>
            </div>
          </div>
          <a href="" onClick={handleSubmit} className="signup">
            {" "}
            Sign up{" "}
          </a>
        </div>
